...
import { CheckCircle2, Crown, ArrowRight, Sparkles, Star, CalendarDays } from "lucide-react";
...
const SuccessProYearly = () => {
  ...
  return (
    <>
      <SEOHead
        title="Welcome to StudyHub Pro Yearly"
        description="Your StudyHub Pro Yearly plan is active. Enjoy 12 months of enhanced Nova AI, advanced study tools, premium themes, and more."
        canonical="https://studyhub.world/success/pro/yearly"
        noIndex
      />
      <Navbar />
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-3xl px-4 pt-20 pb-16 sm:pt-28 sm:pb-24 text-center">
            ...
            <p className="mt-5 text-base sm:text-lg text-muted-foreground max-w-xl mx-auto">
              Payment confirmed — thank you for going yearly! Your{" "}
              <span className="font-semibold text-foreground">$39.99/year</span> plan is now
              active for the next 12 months. You're saving over{" "}
              <span className="font-semibold text-foreground">33%</span> vs. monthly — enjoy every
              Pro feature, including everything we ship next.
            </p>

            <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-border/60 bg-muted/40 px-4 py-1.5 text-xs text-muted-foreground">
              <CalendarDays className="h-3.5 w-3.5" />
              Billed annually · Renews in 12 months
            </div>
            ...
            <Card className="mt-12 rounded-2xl border-primary/40 bg-card/80 backdrop-blur p-6 sm:p-8 text-left shadow-[0_0_0_1px_hsl(var(--primary)/0.2),0_20px_60px_-30px_hsl(var(--primary)/0.5)]">
              <h2 className="text-lg font-semibold tracking-tight">Your Pro Yearly perks</h2>
              <ul className="mt-4 grid gap-3 sm:grid-cols-2 text-sm text-foreground/90">
                <li className="flex items-start gap-2"><CheckCircle2 className="mt-0.5 h-4 w-4 text-primary shrink-0" /> 12 months of unlimited Nova AI + AI image uploads</li>
                ...
                <li className="flex items-start gap-2"><CheckCircle2 className="mt-0.5 h-4 w-4 text-primary shrink-0" /> Premium themes + yearly-only themes & Pro badge</li>
                ...
                <li className="flex items-start gap-2"><CheckCircle2 className="mt-0.5 h-4 w-4 text-primary shrink-0" /> Save 33%+ vs. monthly billing</li>
              </ul>
...
export default SuccessProYearly;
