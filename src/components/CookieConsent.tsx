...
const CookieConsent = () => {
  ...
  return createPortal(
    <div
      className="fixed bottom-16 md:bottom-0 left-0 right-0 z-[9999] p-3 sm:p-4 pb-[calc(0.75rem+env(safe-area-inset-bottom))] bg-card/95 backdrop-blur-md border-t border-border/50 shadow-lg animate-slide-up"
    >
