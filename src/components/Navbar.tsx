import { User, LogOut, Home, HelpCircle, Users, Settings, UserPlus, Timer, Sparkles, Megaphone, Bookmark, Bell, Sun, Moon, Download, Calendar, Palette, Rss, NotebookPen, Trophy } from "lucide-react";
