          ...
          <div className="col-span-2 md:col-span-4 space-y-3">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <a href="https://twelve.tools" target="_blank" rel="noopener noreferrer" aria-label="Featured on Twelve Tools">
                <img src="https://twelve.tools/badge0-light.svg" alt="Featured on Twelve Tools" width={200} height={54} loading="lazy" />
              </a>
              <a href="https://turbo0.com/item/studyhub-tm" target="_blank" rel="noopener noreferrer" aria-label="Listed on Turbo0">
                <img src="https://img.turbo0.com/badge-listed-dark.svg" alt="Listed on Turbo0" style={{ height: 54, width: "auto" }} loading="lazy" />
              </a>
              ...
              <a href="https://startupfa.me/s/studyhub?utm_source=www.studyhub.world" target="_blank" rel="noopener noreferrer" aria-label="Featured on Startup Fame">
                <img src="https://startupfa.me/badges/featured/dark-rounded.webp" alt="StudyHub - Featured on Startup Fame" width={171} height={54} loading="lazy" />
              </a>
              <a href="https://fazier.com/launches/www.studyhub.world" target="_blank" rel="noopener noreferrer" aria-label="Featured on Fazier">
                <img src="https://fazier.com/api/v1//public/badges/launch_badges.svg?badge_type=launched&theme=dark" width={120} alt="Fazier badge" loading="lazy" />
              </a>
              <a
