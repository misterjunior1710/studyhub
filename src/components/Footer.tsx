        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="col-span-2 md:col-span-1 space-y-3">
            <div className="flex items-center gap-2.5 flex-wrap">
              <div className="flex h-10 w-10 sm:h-11 sm:w-11 items-center justify-center rounded-xl bg-gradient-to-br from-primary/25 to-accent/25 border border-primary/10">
                <StudyHubLogo className="h-6 w-6 sm:h-7 sm:w-7" />
              </div>
