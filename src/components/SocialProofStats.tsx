...
const METRICS = [
  { key: "impressions", label: "Total impressions", value: 1090, suffix: "", icon: Eye, format: "compact" as const },
  { key: "clicks", label: "Total clicks", value: 249, suffix: "", icon: MousePointerClick, format: "int" as const },
