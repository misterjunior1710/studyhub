...
const METRICS = [
  { key: "impressions", label: "Total impressions", value: 9020, suffix: "", icon: Eye, format: "compact" as const },
  { key: "clicks", label: "Total clicks", value: 220, suffix: "", icon: MousePointerClick, format: "int" as const },
...
const SocialProofStats = memo(function SocialProofStats() {
  ...
  const heroCount = useCountUp(9020, visible);
