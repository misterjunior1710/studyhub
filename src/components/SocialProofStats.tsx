...
const METRICS = [
  { key: "impressions", label: "Total impressions", value: 9430, suffix: "", icon: Eye, format: "compact" as const },
  { key: "clicks", label: "Total clicks", value: 227, suffix: "", icon: MousePointerClick, format: "int" as const },
